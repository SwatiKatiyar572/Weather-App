...
class App extends React.Component {
  ...
  componentDidMount() {
    ...
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(position => {
        ...
        //Weather Api call
        Axios.get(`http://api.weatherstack.com/current?access_key=416b11dd6ab301f109f0d880238f8f64&query=${this.state.userPosition.latitude},${this.state.userPosition.longitude}`).then(res => {
  ...
  changeLocation = (e) => {
    ...
    Axios.get(`http://api.weatherstack.com/current?access_key=416b11dd6ab301f109f0d880238f8f64=${this.state.regionInput}`).then(res => {
